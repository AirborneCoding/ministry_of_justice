            ...
            <div className='flex flex-col justify-between px-8 py-20 space-y-16 text-white bg-myBlue body-container md:px-0 lg:flex-row lg:space-y-0'>
                {footer.map((item) => {
                    ...
                    return (
                        <ul key={id} className={``}>
                            <li>
                                <h2 className='mb-8 text-3xl font-bold text-white underline underline-offset-8 decoration-grona'>
                                    {title}
                                </h2>
                            </li>
                            {info.map((i: any, index) => (
                                <li
                                    key={index}
                                    className={`flex items-center gap-x-5 text-white`}
                                >
